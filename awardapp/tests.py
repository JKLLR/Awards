...
class ProfileTestClass(TestCase):
    def setUp(self):
        self.lorna = User(username = "jeff", email = "jeff@gmail.com",password = "1234")
        self.profile = Profile(user= self.lorna, profile_pic='mepng',bio='bio', location='Nairobi, Kenya', email='jeff@gmail', link='www.profile.com')
        self.lorna.save()
